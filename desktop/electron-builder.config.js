...
export default {
  productName: 'TheVisionReality',
  appId: 'com.vuisme.thevisionreality',
  ...
  appx: {
    identityName: 'vuisme.TheVisionReality',
    publisher: 'CN=E67CC10B-A1BE-413C-BC3B-6E1137E0742D',
    publisherDisplayName: 'vuisme',
    languages: ['zh-CN', 'en-US', 'zh-TW', 'vi-VN'],
  },
  ...
  publish: {
    ...
    owner: 'vuisme',
    repo: 'escrcpy',
    updaterCacheDirName: 'thevisionreality-updater',
  },
}
